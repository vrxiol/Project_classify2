...
A4 = st.number_input("กรุณาเลือกข้อมูลของเจ็บหน้าอก")
A5 = st.number_input("กรุณาเลือกข้อมูลของเจ็บหน้าอก")
A6 = st.number_input("กรุณาเลือกข้อมูลของเจ็บหน้าอก")
A7 = st.number_input("กรุณาเลือกข้อมูลของเจ็บหน้าอก")
A8 = st.number_input("กรุณาเลือกข้อมูลของเจ็บหน้าอก")
A9 = st.number_input("กรุณาเลือกข้อมูลของเจ็บหน้าอก")
A10 = st.number_input("กรุณาเลือกข้อมูลของเจ็บหน้าอก")
A11 = st.number_input("กรุณาเลือกข้อมูลของเจ็บหน้าอก")
